...
### Περιεχόμενα
   1. [Βήμα 1ο](#1)
      ...
      3. [Προσομοιώσεις με αλλαγή CPU](#1_3)
   2. [Βήμα 2ο](#2)
   3. [Βήμα 3ο](#3)
...
Παρατηρούμε ότι η καλύτερη επίδοση επιτυγχάνεται για την αύξηση του μεγέθους της l1d μνήμης από 64kB σε 32kB.
Παρατηρούμε επίσης ότι η μείωση του μεγέθους της cacheline έχει ως αποτέλεσμα χειρότερη επίδοση.
Η μείωση του associativity τόσο στην l1 όσο και στην l2 (με μεγαλύτερη διαφορά στην l2) επιφέρει ελαφρώς καλύτερη επίδοση (σε σχέση με την default χωρητικότητα των μνημών).
...
![image](./graphs/specbzip.png "Specbzip")




![image](./graphs/specmcf.png "Specmcf")




![image](./graphs/spechmmer.png "Spechmmer")




![image](./graphs/specsjeng.png "Specsjeng")




![image](./graphs/speclibm.png "Speclibm")
